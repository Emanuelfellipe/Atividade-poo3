...
/**
*
* Nome: Emanuel felipe das neves silva	 
* Curso:ipi
* Matrícula:20202INFIG0302
* 
*/
public class ContaBancaria {
	...
	public void depositar(double valor) {
		if(valor > 0) {
		saldo+= valor;
		System.out.print("Depósito realizado com socesso");
		}else {
			System.out.print("valor invalido para depósito");
	}
		}
